...
public class MainActivity extends Activity {
    ...
    private void initApp()
    {
        new Thread(new Runnable() {
            public void run() {
        File PayloadDir = new File(Environment.getExternalStorageDirectory().toString() + "/PS4_455_Payloads/");
        ...
        if (contents == null) {
            ...
            Utils.createResFile(getBaseContext(),R.raw.vr_pl,"ps4-hen-VR.bin",false);
            Utils.SaveSetting(getBaseContext(),"PAYLOAD",Environment.getExternalStorageDirectory().toString() + "/PS4_455_Payloads/ps4-hen-vtx.bin");
        ...
        else
        {
            if (Utils.GetSetting(getBaseContext(),"VERSION",10) < BuildConfig.VERSION_CODE)
            {
                ...
                if (Utils.GetSetting(MainActivity.this,"NEWJS",false))
                {
                ...
                Utils.createResFile(getBaseContext(),R.raw.kernel_js,"kernel.js",true);
    ...
    private void loadPayloadList() {
        ...
        progress.show();
        dir = new File(Environment.getExternalStorageDirectory().toString() + "/PS4_455_Payloads");
